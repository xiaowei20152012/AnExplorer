...
import com.fast.explorer.misc.ImageUtils;
import com.fast.explorer.misc.OsCompat;
import com.fast.explorer.misc.Utils;
import com.fast.explorer.provider.DocumentsProvider;
import com.fast.explorer.provider.UsbStorageProvider;

import static com.fast.explorer.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     * {@link com.fast.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.fast.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.fast.explorer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.fast.explorer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.fast.explorer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.fast.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.fast.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
