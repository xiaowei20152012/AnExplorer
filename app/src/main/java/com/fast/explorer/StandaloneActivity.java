...
public class StandaloneActivity extends BaseActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mRootsToolbar = (Toolbar) findViewById(com.fast.explorer.R.id.roots_toolbar);
    ...
    public void onDocumentPicked(DocumentInfo doc) {
        ...
        if (doc.isDirectory()) {
            ...
            try {
                ...
                Toast.makeText(this, com.fast.explorer.R.string.toast_no_application, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private class CreateFinishTask extends AsyncTask<Void, Void, Uri> {
        ...
        protected void onPostExecute(Uri result) {
            if (result != null) {
                ...
                Toast.makeText(StandaloneActivity.this, com.fast.explorer.R.string.save_error, Toast.LENGTH_SHORT)
                        .show();
            }
            setPending(false);
        }
